...
const pages: PageDef[] = [
  ...
  {
    slug: "travel-trips-info",
    label: "Travel & Trips Page",
    icon: Plane,
    color: "#0891b2",
    defaultData: {
      title: "Travel & Trips",
      subtitle: "Curated travel experiences and adventure packages across Ghana and beyond.",
      heroImage: "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=1920&q=80",
      sections: [
        { heading: "Trip Types", body: "Beach Getaways · Safari & Wildlife · City Tours · Cultural Experiences · Adventure Trips · Romantic Escapes · Family Vacations · Corporate Retreats" },
        { heading: "What's Included", body: "All our packages include transportation, accommodation, meals, and guided tours. We handle every detail so you can focus on creating memories." },
        { heading: "Popular Destinations", body: "Cape Coast · Elmina · Kakum National Park · Mole National Park · Volta Region · Ada Foah · Busua Beach · Lake Bosomtwe · Accra City Tours" },
        { heading: "Booking Process", body: "Browse available trips, select your dates, pay 50% deposit to secure your spot. Balance due 7 days before departure." },
      ],
    },
  },
  {
    slug: "graphic-design-info",
    label: "Graphic Design Page",
    icon: Palette,
    color: "#f97316",
    defaultData: {
      title: "Graphic Design Studio",
      subtitle: "Professional design services to elevate your brand and grow your business.",
      sections: [
        { heading: "Our Services", body: "Logo Design · Brand Identity · Business Cards · Brochures & Flyers · Social Media Graphics · Web Banners · Packaging Design · T-Shirt Design · Infographics · Book Covers" },
        { heading: "Why Choose Us", body: "Expert designers with diverse industry experience\\n100% original custom designs\\nFast turnaround times\\nUnlimited revisions on premium packages\\nFull ownership rights included" },
        { heading: "Pricing", body: "Logo Design from GH₵500\\nBrand Identity from GH₵3,500\\nPrint Design from GH₵150\\nSocial Media Kit from GH₵800\\nPackaging Design from GH₵1,200" },
        { heading: "Process", body: "1. Submit your brief and requirements\\n2. Receive initial concepts within agreed timeline\\n3. Review and provide feedback\\n4. Revisions until you're satisfied\\n5. Receive final files in all formats" },
      ],
    },
  },
];
...
function AdminContentInner() {
  ...
  const addSection = () => {
    ...
    setForm({
      ...form,
      sections: [...form.sections, { heading: "New Section", body: "", image: "" }],
    });
  };
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="md:col-span-2">
              <ImageUpload
                ...
                hint="Upload or paste a URL for the page hero banner"
              />
            </div>
          </div>
        </div>
          ...
          {form.sections.map((sec, i) => (
            ...
            >
              ...
              <div>
                ...
                />
                <p className="text-[10px] text-slate-400 mt-1">For team members: use &quot;Role: …&quot;, &quot;Image: url&quot;, &quot;Bio: …&quot; on separate lines</p>
              </div>
              <div>
                <ImageUpload
                  value={sec.image || ""}
                  ...
                  hint="Upload a photo for this section — e.g. team headshot, project photo"
                />
              </div>
            </div>
          ))}
