...
import { ArrowLeft, Home, Car, Utensils, Plane, Scissors, Truck, Wrench, ShoppingBag, ChevronRight, Pencil, Palette } from "lucide-react";
...
const lines = [
  ...
  { key: "car-rental", name: "Car Services", icon: Car, color: "#2563eb", href: "/services/car-rental", cms: "/admin/cars", blurb: "Rentals and sales. Manage vehicles from the Cars CMS." },
  ...
  { key: "logistics", name: "Logistics", icon: Truck, color: "#059669", href: "/services/logistics", cms: "/admin/logistics", blurb: "Full CMS for domestic, international, warehousing, and freight pricing." },
  ...
  { key: "graphic-design", name: "Graphic Design", icon: Palette, color: "#f97316", href: "/services/graphic-design", cms: "/admin/graphic-design", blurb: "Logos, branding, print & digital design. Manage pricing from the CMS." },
];
