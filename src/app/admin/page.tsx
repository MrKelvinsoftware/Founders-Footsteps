...
import {
  ...
  Bell, Search, Home, Car, Utensils, Plane, Scissors, Truck, Wrench,
  Activity, Mail, ArrowRight, CircleDot,
...
function Dashboard({ user }: { user: { firstName: string; lastName: string; email: string } }) {
