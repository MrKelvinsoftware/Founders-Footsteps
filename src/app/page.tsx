import { ArrowRight, Star, Shield, Headphones, Clock, CheckCircle, Home, Car, Utensils, Plane, Scissors, Truck, Wrench, ShoppingBag, Heart, Building2, Palette } from "lucide-react";
...
export default function HomePage() {
  const serviceLines = [
    ...
    { name: "Graphic Design", slug: "graphic-design", icon: Palette, color: "#f97316", description: "Professional design services for your brand and business", features: ["Logo Design", "Brand Identity", "Print & Digital Design"] },
